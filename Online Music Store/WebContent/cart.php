...
<html>
	<head>
		<title>Shopping Cart Attempt</title>
	...
	<body>
		...
		<div class="container">
			...
			<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="cart-row" style="padding-top: 1em;">
                        <div class="cart-item cart-column">
                            <img src="./Images/<?php echo $row["image"]; ?>" alt="" class="cart-item-image"
                            width="100" height="100">
                            <span class="cart-item-title"><?php echo $row["name"]; ?></span>
                        </div>
                        <span class="cart-item-title cart-price" style="padding-right: 3%;">$ <?php echo $row["price"]; ?></span>
                        <div class="cart-quantity cart-column">
                            <input type="number" value="1" class="cart-quantity-input">
							<button class="btn btn-danger"
							type="button">REMOVE FROM CART</button>
                        </div>
					</div>
					<!-- /From me -->
			<?php
